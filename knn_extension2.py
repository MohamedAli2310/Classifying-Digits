...
def main():
    ...
    output = get_accuracy(train_data, test_data, [1])
    print("               Predicted: 2    Predicted:  3 ")
    print("  Actual: 2     TN = ", output[1], "     FP = ", output[4])
    print("  Actual: 3     FN = ", output[2], "     TP = ", output[3])
...
def get_accuracy(train_data, test_data, k_list):
    ...
    return accuracy_dict, TN, FN, TP, FP
